...
const API_KEY = credentials.apiKey,
      ...
      TEXT1 =
        'Не подавай виду что тебя что-то задело, '+ 
        'Просто улыбайся и делай выводы.',
      TEXT2 =
...
function translate(/**String*/ key, /**String*/ text, /**String*/ lang, /**String=*/ format, /**Number=*/ options, /**String=*/ jsonpCallback, /**function=*/ callback) {
  callback = (typeof callback === 'function') ? callback : function() {};
  var url  = BASE_URL + 'translate'  + '?' + 'key=' + key + '&text=' + encodeURIComponent(text) + (lang ? '&lang='+lang : '') + '&format=' + format + '&options=' + options + (jsonpCallback ? '&callback='+jsonpCallback : '');
  request({
      url:    url,
      method: 'GET'
    },
...
translate(API_KEY, TEXT2, 'ru-en', 'plain', 1);
translate(API_KEY, TEXT1,    'ru-fr', 'html', 1);
