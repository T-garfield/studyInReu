...
const API_KEY = credentials.apiKey,
      ...
      TEXT2 =
        ...
        'Йо-хо-хо, и бутылка рому!',
      TEXT3 = 
      'Ингредиенты: Яблоко  — 4-5 Штук Яйцо  — 4 Штуки Мука  — 1 Стакан Сахар  — 1 Стакан Разрыхлитель  — 0,5 Чайных ложки Сливочное масло  — 30 Грамм';
...
translate(API_KEY, TEXT2,    'fr', 'html');
translate(API_KEY, TEXT3, 'ru-en', 'html');
