  ...
  function (error, response, body) {
	...
	body = iconv.decode(body, fromEnc);
      ...
      parseString(body, function (err, result) {
        ...
        var curr = result.ValCurs.Valute[7];
        console.log('\x1b[36m%s\x1b[0m', String('100 ' +curr.Name+' ('+curr.CharCode+')'),' =','\x1b[32m',String(curr.Value), 'Российских рублей (RUB)','\x1b[0m');
