...
const API_KEY = credentials.apiKey,
      ...
      TEXT2 =
        ...
        'Йо-хо-хо, и бутылка рому!';
      const TEXT3 = 
      ` Ты хочешь мести, ты хочешь жести. Плохие вести – мы будем вместе. Как в такой красивой голове помещается столько отвратительных идей?!`
...
translate(API_KEY, TEXT3, 'ru-kk', 'plain');
