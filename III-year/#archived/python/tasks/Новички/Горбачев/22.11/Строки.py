...
print("///Строки и условные выражения///")
...
print(letter_check('Гиги за шаги' , 'и'))
...
def common_letters(string_one, string_two):
    ...
    for letter in string_one:
        if letter in string_two and not letter in list:
            list.append(letter)
    return list
print(common_letters("покуда колизей неколибим " , 
...
def username_generator(first_name, last_name):
    ...
    return username         
print(username_generator('Ryan', 'Gosling'))


def password_generator(username):
    username = username_generator('Ryan', 'Gosling')
    password= username[-1] + username[:-1] 
    return password
print(password_generator(username_generator('Ryan', 'Gosling')))
print("")
print("")
print("")
