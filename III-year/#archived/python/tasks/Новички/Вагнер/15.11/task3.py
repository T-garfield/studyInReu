...
if user_name == "Ангелина":print (check)
#4 задание (больше/меньше)
enter_number = 3
if enter_number < 3: print ( f'Попробуйте еще раз. У вас осталось {3-enter_number} попыток.')
...
grade = input()
if grade >= "4": print("A")
elif grade >= "3": print("B")
elif grade >= "2": print("C")
elif grade >= "1": print("D")
else: print("F")
