...
for value in num_exercises.values():
    total_exercises = total_exercises + value
print(total_exercises)

tarot = { 1: "The Magician", 2: "The High Priestess", 3: "The Empress",4: "The Emperor", 5: "The Hierophant", 6: "The Lovers", 7: "The Chariot", 8: "Strength", 9: "The Hermit", 10: "Wheel of Fortune", 11: "Justice",12: "The Hanged Man", 13: "Death",
         14: "Temperance", 15: "The Devil", 16: "The Tower", 17: "The Star", 18: "The Moon", 19: "The Sun", 20: "Judgement", 21: "The World", 22: "The Fool"}
spread = {}
past = tarot[13]
spread.update({"past":past})
present = tarot[22]
spread.update({"present":present})
future = tarot[10]
spread.update({"future":future})
print(spread)
